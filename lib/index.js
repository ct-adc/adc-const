...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_82__, __WEBPACK_EXTERNAL_MODULE_83__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_axios__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ct_utility__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ct_utility___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_ct_utility__);
...
var Const = function () {
    function Const(config) {
        __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_classCallCheck___default()(this, Const);

        this.config = __WEBPACK_IMPORTED_MODULE_6_ct_utility___default.a.base.extend(true, {}, defaultConfig, config);
    }

    __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(Const, [{
        key: 'isAsync',
        ...
        value: function add() {
            ...
            __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys___default()(dataList).map(function (col) {
        ...
        value: function register(col, options) {
            if (typeof this[col] === 'undefined') {
                this.defineData(col);
                this[col].options = __WEBPACK_IMPORTED_MODULE_6_ct_utility___default.a.base.extend(true, {}, defaults, options);
            } else {
        ...
        value: function defineData(col) {
            ...
            this[col] = function () {
                ...
                options = __WEBPACK_IMPORTED_MODULE_6_ct_utility___default.a.base.extend(true, {}, _this2[col].options, options);

                if (options.cache && _this2.isHasCache(col)) {
                    return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a.resolve(_this2[col].data);
                }

                return __WEBPACK_IMPORTED_MODULE_5_axios___default.a.request(options.axios).then(function (response) {
                    var res = response.data;

                    if (options.resolve) {
                        if (res.status) {
                            _this2[col].data = _this2.resolveData(res.data, options.resolve.key, options.resolve.val, options.default);
                            return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a.resolve(response);
                        }
        ...
        value: function ensure(list) {
            ...
            return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a.all(promiseList);
        }
    }, {
        key: 'getData',
        value: function getData(_ref) {
            var col = _ref.col,
                _ref$hasDef = _ref.hasDef,
                hasDef = _ref$hasDef === undefined ? true : _ref$hasDef,
                _ref$def = _ref.def,
                def = _ref$def === undefined ? '不限' : _ref$def,
                filterByKey = _ref.filterByKey,
                filterByVal = _ref.filterByVal;
            ...
            var defaultItem = JSON.parse(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(data[0]));
            var dataClone = JSON.parse(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(data)).slice(1);
